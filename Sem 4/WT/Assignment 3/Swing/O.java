// Write a java Program to find Second largest number among three input using swing.
import javax.swing.*;
import java.awt.*;
...
public class O extends JFrame implements ActionListener{
    ...
    public O(){
        ...
        o=new JLabel("Output:");n=new JLabel();f=new JButton("Find 2nd max");f.addActionListener(this);
    ...
    public void actionPerformed(ActionEvent a){
        ...
        if(s=="Find 2nd max"){
            ...
            n.setText(String.valueOf((n1<=n2&&n1>=n3||n1>=n2&&n1<=n3)?n1:(n2<=n1&&n2>=n3||n2>=n1&&n2<=n3)?n2:n3));
        }
    }
