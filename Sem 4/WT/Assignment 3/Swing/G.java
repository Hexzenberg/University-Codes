// Write a java program to find out the maximum of three number using swing
import javax.swing.*;
import java.awt.*;
...
public class G extends JFrame implements ActionListener{
    ...
    public G(){
        ...
        o=new JLabel("Output:");n=new JLabel();f=new JButton("Find Max");f.addActionListener(this);
