// Write a java Program to find Second minimum number among three input using swing
import javax.swing.*;
import java.awt.*;
...
public class R extends JFrame implements ActionListener{
    ...
    public R(){
        ...
        o=new JLabel("Output:");n=new JLabel();f=new JButton("Find 2nd min");f.addActionListener(this);
